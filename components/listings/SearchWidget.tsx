...
export default function SearchWidget({ categoryItems }: { categoryItems: CategoryItem[] }) {
          ...
          <div className="flex flex-col gap-2 sm:hidden">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 flex items-center gap-1.5 px-3 py-2.5 border border-gray-200 rounded-xl bg-white hover:border-orange-primary transition-colors"
              >
