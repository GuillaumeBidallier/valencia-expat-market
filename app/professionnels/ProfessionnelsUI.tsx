...
export default function ProfessionnelsUI({ pros, cat, city, activeCatLabel, contactEmail = 'contact@vendo.es' }: Props) {
  ...
  return (
    <div className="flex-1 min-w-0">
      ...
      <div className="mt-12 bg-navy rounded-2xl p-6 sm:p-8 text-center text-white">
        ...
        <a
          href={`mailto:${contactEmail}?subject=Référencement professionnel 1000Click`}
